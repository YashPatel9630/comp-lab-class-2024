...
for T in "${temperatures[@]}"; do
    if ! mpirun lmp -var configfile /home/yhp2008/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/n480/kalj_n480_T$T.lmp -var id 1 -in /home/yhp2008/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/production_3d_binary.lmp; then
