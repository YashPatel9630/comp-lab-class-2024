...
for T in "${temperatures[@]}"; do
    if ! mpirun lmp -var configfile /home/yhp2008/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/n360/kalj_n360_T$T.lmp -var id 1 -in /home/yhp2008/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/production_3d_binary.lmp; then
